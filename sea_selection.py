...
STAGE_CONFIGS: Mapping[str, StageConfig] = {
    "B0": StageConfig(
        ...
        outside_corridor_multiplier=4.0,
        calm_wave_penalty=3.5,
    ...
    "B1": StageConfig(
        ...
        outside_corridor_multiplier=2.5,
        calm_wave_penalty=2.0,
    ...
    "B2": StageConfig(
        ...
        outside_corridor_multiplier=1.5,
        calm_wave_penalty=1.2,
    ...
    "AN": StageConfig(
        ...
        season_mismatch_extra=0.5,
        outside_corridor_multiplier=0.5,
        calm_wave_penalty=0.0,
