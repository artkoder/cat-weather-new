...
def test_backfill_wave_metrics_from_vision(tmp_path):
    ...
    vision_json_1 = {
        "weather": {"sea": {"wave_score": 2.5, "confidence": 0.90}, "sky": {"bucket": "clear"}}
    }
    ...
    vision_json_2 = {"sea_state": {"score": 7.0, "confidence": 0.85}, "sky_bucket": "overcast"}
    ...
    conn.execute(
        ...
        """,
        ("asset3", "2024-01-17T10:00:00", "telegram", "{}", 3.5, 0.88, "partly_cloudy"),
    )
