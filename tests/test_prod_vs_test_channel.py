...
async def test_prod_publish_uses_prod_channel(tmp_path):
    ...
    job_row = bot.db.execute("SELECT payload FROM jobs_queue WHERE id=?", (job_id,)).fetchone()
